package at.jku.dke.task_app.sql_ddl_new.data.entities;
...
/**
 * Represents a SQL DDL NEW task group.
 * <p>
 * It is also possible to create tasks without task types. Tasks of type sql_ddl_new would not need a task group.
