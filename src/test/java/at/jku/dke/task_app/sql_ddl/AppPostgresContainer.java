...
class AppPostgresContainer extends PostgreSQLContainer<AppPostgresContainer> {
    ...
    public static final String USERNAME = "etutor_sql_ddl_test_admin";
    public static final String PASSWORD = "strong-password";
    public static final String ETUTOR_USERNAME = "etutor_sql_ddl_test";
    public static final String ETUTOR_PASSWORD = "etutor_sql_ddl_pwd";
